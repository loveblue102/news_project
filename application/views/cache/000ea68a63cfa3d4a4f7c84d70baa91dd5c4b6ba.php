<?php /* C:\xampp\htdocs\ows_news\application\views/admin/AddNews.blade.php */ ?>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form method="post" action="<?php echo e($formAction); ?>" enctype="multipart/form-data">
					...
					<?php if(isset($data) && $session["per_name"] != "mod"): ?>
					<div class="row" style="margin:5px">
						...
						<div class="col-md-10">
							<select name="status" id="" style="width: 114px">
								<?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option <?= isset($value["news_status"]) && $value["news_status"] == $data["news_status"]?"selected":""; ?> value="<?php echo e($value["news_status"]); ?>"><?php echo e($value["news_status"]); ?></option>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							</select>
						</div>
					</div>
