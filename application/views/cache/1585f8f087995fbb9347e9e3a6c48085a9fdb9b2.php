					...
					<div class="classy-menu">
						...
						<div class="classynav">
							<ul>
								...
								<li><a href="<?= base_url()."News/Category/".$value["category_id"] ?>"><?php echo e($value['category_name']); ?> </a>
									...
									<ul class="dropdown">
										<?php $__currentLoopData = $value['category_child']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<li><a href="<?php echo e(base_url()."News/Category/".$rows["category_id"]); ?>"><?php echo e($rows['category_name']); ?> </a></li>
