<?php /* C:\xampp\htdocs\ows_news\application\views/admin/EditMyNews.blade.php */ ?>
<?php $__env->startSection('content'); ?>
	<script language="JavaScript" src="<?= base_url() ?>asset/ckeditor/ckeditor.js"></script>
	<script language="JavaScript" src="<?= base_url() ?>asset/ckfinder/ckfinder.js"></script>
							...
							<div class="col-md-10">
								<select name="status" id="" style="width: 114px">
									<?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<option <?php if(isset($session)&& $session["per_name"] == "mod" && $value["news_status"] == "Đã Đăng"){?>disabled<?php } ?> <?= isset($value["news_status"]) && $value["news_status"] == $data["news_status"]?"selected":""; ?> value="<?php echo e($value["news_status"]); ?>"><?php echo e($value["news_status"]); ?></option>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</select>
							</div>
						</div>
