<?php /* C:\xampp\htdocs\ows_news\application\views/NewsDetails.blade.php */ ?>
			...
			<div class="row h-100 align-items-center">
				<div class="col-12">
					<div class="breadcrumb-content">
						<h2>
							<?php echo e(isset($param["categoryParent"]) ? $param["categoryParent"]." / ".$param["categorySlide"] : $param["categorySlide"]); ?>
					...
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#"><i class="fa fa-home" aria-hidden="true"></i>
									Home</a></li>
							<?php if(isset($param["categoryParent"])): ?>
								<li class="breadcrumb-item"><a href="#"><?php echo e($param["categoryParent"]); ?></a></li>
								<li class="breadcrumb-item"><a href="#"><?php echo e($param["categorySlide"]); ?></a></li>
							<?php else: ?>
								<li class="breadcrumb-item"><a href="#"><?php echo e($param["categorySlide"]); ?></a></li>
							<?php endif; ?>
						</ol>
			...
			<div class="col-12 col-xl-8">
				...
				<div class="post-details-content bg-white mb-30 p-30 box-shadow">
					...
					<div class="blog-content">
						<div class="post-meta">
							<?php if(isset($param["categoryParent"])): ?>
								<a href="<?= base_url()?>News/Category/<?= $param["categoryParentId"] ?>"><?php echo e($param["categoryParent"]); ?></a>
								<a href="<?= base_url()?>News/Category/<?= $param["categorySlideId"] ?>"><?php echo e($param["categorySlide"]); ?></a>
							<?php else: ?>
								<a href="<?= base_url()?>News/Category/<?= $param["categorySlideId"] ?>"><?php echo e($param["categorySlide"]); ?></a>
							<?php endif; ?>
						</div>
						<h4 class="post-title"><?php echo e($param["news_title"]); ?></h4>
						<!-- Post Meta -->
						...
						<h5><?php echo $param["news_description"]; ?></h5>


						<blockquote>
							<h6 class="quote-text"><?php echo $param["news_content"]; ?></h6>
						</blockquote>
				...
				<div class="related-post-area bg-white mb-30 px-30 pt-30 box-shadow">
					...
					<div class="row">
						<!-- Single Blog Post -->
						<?php $__currentLoopData = $arrSame; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<div class="single-blog-post style-4 mb-30">
									...
									<div class="post-content">
										<a href="<?= base_url()?>News/NewsDetail/<?= $value["news_id"] ?>"
										   class="post-title"><?php echo e($value["news_title"]); ?></a>
					...
					<!-- Single CommentModel Area -->
						<li id="single_comment_area" class="single_comment_area">
							...
							<form action="" method="post">
								<input type="hidden" id="comment_id" name="comment_id" value="<?php echo e($param["news_id"]); ?>">
								<input type="hidden" id="user_id" name="user_id" value="<?php echo e($param["user_id"]); ?>">
							...
							<div class="comment-content d-flex" >
								...
								<div class="comment-meta">
									<a href="#" class="comment-date"><?php echo e($value["comment_date"]); ?></a>
									<input type="hidden" id="commentc" name="comment_id" value=" <?php echo e($value["comment_id"]); ?>  ">
									<h6><?php echo e($value["username"]); ?></h6>
									<p><?php echo e($value["comment_content"]); ?></p>
									...
									<form action="" class="frm<?= $value['comment_id']?>" id="frm<?= $key ?>" method="post" style='width: 100%;display: none'>
										<input type="hidden" id="comment_rep_parent" name="comment_id" value=" <?php echo e($value["comment_id"]); ?>  ">
										<input type="hidden" id="news_rep_id" name="comment_id" value=" <?php echo e($value["news_id"]); ?> ">
								...
								<div class="" id="comment-content<?= $value['comment_id']?>" >
									...
									<?php if( isset($value["repcomment"])): ?>
							<!-- CommentModel Meta -->
							<!-- End Comment Cha -->

							<?php $__currentLoopData = $value["repcomment"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<ol class="children">
									<li class="single_comment_area">
										...
										<div class="comment-content d-flex">
											...
											<div class="comment-meta">
												<a href="#" class="comment-date"><?php echo e($rows ["comment_date"]); ?></a>
												<h6><?php echo e($rows["child"]["username"]); ?></h6>
												<p><?php echo e($rows["comment_content"]); ?></p>
												<div class="d-flex align-items-center">
												</div>
											</div>
										</div>
							...
							<ul class="catagory-widgets">
								<?php $__currentLoopData = $arrParent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<li><a href="<?= base_url() . "News/Category/" . $value["category_id"] ?>"><span><i
														...
														aria-hidden="true"></i> <?php echo e($value['category_name']); ?></span>
										...
										<?php $__currentLoopData = $value['category_child']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<li>
												<a href="<?= base_url() . "News/Category/" . $rows["category_id"] ?>"><span><i
																...
																style="margin-left: 20px"></i> <?php echo e($rows['category_name']); ?></span>
