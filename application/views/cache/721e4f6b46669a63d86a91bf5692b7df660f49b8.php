<?php /* C:\xampp\htdocs\ows_news\application\views/admin/MyNewsDetails.blade.php */ ?>
		...
		<div class="col-md-2">
			<?php if(isset($data) && $data != Null): ?>
				<a href="" class="btn btn-info text-center" style="width:130px ">
					Đã Duyệt</a>
			<?php elseif(isset($PostDetails) && $session["per_name"] != "mod" && ($PostDetails["news_status"] == "Chờ Duyệt" ||  $PostDetails["news_status"] == "Ẩn")): ?>
				<a href="<?= base_url()?>admin/Post/Check/<?=  $PostDetails["news_id"]?>" class="btn btn-info text-center" style="width:130px ">Duyệt Bài</a>
			<?php elseif($PostDetails["news_status"] == "Đã Đăng"): ?>
			...
			<?php endif; ?>
			<a href="<?= base_url()?>admin/MyNews/ListNews" class="btn btn-default back text-center" style="width: 130px;margin: 10px 0px 30px 0px">Quay Lại</a>
		</div>
	</div>
	<div class="row" style="margin: 0px;">
		<div class="col-md-12" style="padding-left: 3px;" ><h4 style="margin-right: 21px"><?php echo $PostDetails["news_description"]; ?></h4></div>
