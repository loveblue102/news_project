<?php /* C:\xampp\htdocs\ows_news\application\views/Home.blade.php */ ?>
							...
							<div class="post-content text-center">
								<div class="post-meta" data-animation="fadeInUp" data-delay="100ms">
									...
									<?php if(isset($value['categoryParent'])): ?>
										<a href="<?= base_url()?>News/Category/<?= $value["categoryParentId"] ?>"><?php echo e($value["categoryParent"]); ?> &nbsp;&nbsp;&nbsp;&nbsp;/</a>
										<a href="<?= base_url()?>News/Category/<?= $value["categorySlideId"] ?>"><?php echo e($value['categorySlide']); ?></a>
									<?php else: ?>
										<a href="<?= base_url()?>News/Category/<?= $value["categorySlideId"] ?>"><?php echo e($value['categorySlide']); ?></a>
									<?php endif; ?>
								</div>
								<a href="<?= base_url()?>News/NewsDetail/<?= $value["news_id"] ?>" class="post-title"
								   data-animation="fadeInUp" data-delay="300ms"><?php echo e($value["news_title"]); ?></a>
	...
	<div class="mag-posts-content mt-30 mb-30 p-30 box-shadow">
		...
		<div class="trending-now-posts mb-30">
			...
			<div class="trending-post-slides owl-carousel">
				...
				<?php $__currentLoopData = $hot; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<div class="single-trending-post">
						...
						<div class="post-content">
							<a href="<?= base_url()?>Category/<?= $value["categorySlideId"] ?>" class="post-cata">
								<?php if(isset($value['categoryParent'])): ?>
									<?php echo e($value["categoryParent"]); ?>
				...
				<div class="row">
					<div class="col-12 col-lg-7">
						...
						<div class="single-featured-post">
							...
							<div class="post-content">
								<div class="post-meta">
									<?php if(isset($new[0]['categoryParent'])): ?>
										<a href="<?= base_url()?>Category/<?= $new[0]["categoryParentId"] ?>"><?php echo e($new[0]["categoryParent"]); ?></a>
										<a href="<?= base_url()?>Category/<?= $new[0]["categorySlideId"] ?>"><?php echo e("/ ".$new[0]['categorySlide']); ?></a>
									<?php else: ?>
										<a href="<?= base_url()?>Category/<?= $new[0]["categorySlideId"] ?>"
										   style="margin: 0px"><?php echo e($new[0]['categorySlide']); ?></a>
									<?php endif; ?>
								</div>
								<a href="<?= base_url()?>News/NewsDetail/<?= $new[0]["news_id"] ?>"
								   class="post-title"><?php echo e($new[0]["news_title"]); ?>    </a>
								<p><?php echo $new[0]["news_description"]; ?> </p>
							</div>
							<!-- Post Share Area -->
		...
		<div class="sports-videos-area">
					...
					<div class="post-content">
						<div class="post-meta">
							<a href="<?= base_url()?>Category/<?= $newHome[0]["maxCategory"]["category_id"] ?>"
							   style="margin: 0px">
								<?php echo e(isset($newHome[0]["maxCategory"]["category_name"])?$newHome[0]["maxCategory"]["category_name"]:""); ?>

							</a>
						</div>
						<a href="<?= base_url()?>News/NewsDetail/<?= $newHome[0]["news_id"] ?>"
						   class="post-title"><?php echo e($newHome[0]["news_title"]); ?></a>
						<p><?php echo $newHome[0]["news_description"]; ?> </p>
					</div>
					<!-- Post Share Area -->
					<div class="post-share-area d-flex align-items-center justify-content-between">
						<!-- Post Meta -->
			...
			<div class="row">
				<!-- Single Blog Post -->
				<?php $__currentLoopData = $newHome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
